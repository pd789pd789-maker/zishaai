        ...
        >
          ...
          <div className="text-center mb-8">
            <h1 className="text-2xl font-serif mb-2">
              {isBetaAuth ? "内测通道" : (isPhoneAuth ? "手机号安全登录" : (isRegister ? "创建您的工作账户" : "登录您的工作空间"))}
            </h1>
          ...
          {isBetaAuth ? (
            <form onSubmit={handleBetaLogin} className="space-y-4">
              ...
              <button
                type="button"
                onClick={() => { setIsBetaAuth(false); setBetaCode(""); }}
                className="w-full text-center text-sm text-zinc-500 hover:text-zinc-300 transition-colors mt-2"
              >
                返回普通登录
              </button>
            </form>
            ...
            <>
              ...
              <button
                type="button"
                onClick={() => setIsBetaAuth(true)}
                className="w-full text-center text-xs text-zinc-600 hover:text-zinc-400 transition-colors mt-6"
              >
                内测通道
              </button>
            </>
